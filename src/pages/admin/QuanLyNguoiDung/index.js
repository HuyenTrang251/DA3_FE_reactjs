...
//   const [selectedUser, setSelectedUser] = useState(null);
//   const [formData, setFormData] = useState({
//     img: null, // Lưu tệp ảnh, không phải chuỗi base64
//     full_name: "",
//     email: "",
//     phone: "",
//     password: "",
...
//     setSelectedUser(user);
//     setFormData({
//       img: null, // Reset ảnh khi chỉnh sửa, cho phép chọn ảnh mới
//       full_name: user.full_name || "",
//       email: user.email || "",
//       phone: user.phone || "",
//       password: user.password || "",
...
//                 <td>{user.id_user}</td>
//                 <td>
//                   <img src={`/upload/${user.img}`} alt="" width="50" />
//                 </td>
//                 <td>{user.full_name}</td>
//                 <td>{user.email}</td>
//                 <td>{user.phone}</td>
